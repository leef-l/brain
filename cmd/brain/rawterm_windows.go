...
// enableRawInput configures the Windows console to emit VT input sequences and
// accept ANSI/VT output sequences, matching the semantics used by the POSIX
// raw-terminal backends.
