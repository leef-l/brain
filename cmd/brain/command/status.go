...
type RunLoader func(id string) (*cliruntime.Runtime, *cliruntime.RunRecord, *persistence.Checkpoint, error)

func RunStatus(args []string, loadRun RunLoader) int {
